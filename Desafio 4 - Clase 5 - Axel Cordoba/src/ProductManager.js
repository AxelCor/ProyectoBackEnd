...
export class ProductManager {
    ...
    addProduct(
        ...
        this.#verificarString("title", addedProduct);
        this.#verificarString("description", addedProduct);
        this.#verificarNumber("price", addedProduct);
        // this.#verificarString("thumbnail", addedProduct);
        this.#verificarString("code", addedProduct);
        this.#verificarNumber("stock", addedProduct);
        this.#verificarString("category", addedProduct);
